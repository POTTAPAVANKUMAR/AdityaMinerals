...
// Show Hide Edit EContact Info Card
$(".edit-Econtact-card").hide();
$("#edit-Econtact-info").click(function () {
    $(".edit-Econtact-card").show();
    $(".view-Econtact-card").hide();
});
$("#view-Econtact-info").click(function () {
    $(".view-Econtact-card").show();
    $(".edit-Econtact-card").hide();
});
$("#reset-Econtact-info").click(function () {
    $(".view-Econtact-card").show();
    $(".edit-Econtact-card").hide();
});

//// Show Hide Edit Banking Info Card
//$(".edit-banking-card").hide();
//$("#edit-banking-info").click(function () {
//    $(".edit-banking-card").show();
//    $(".view-banking-card").hide();
//});
//$("#view-banking-info").click(function () {
//    $(".view-banking-card").show();
//    $(".edit-banking-card").hide();
//});
//$("#reset-banking-info").click(function () {
//    $(".view-banking-card").show();
//    $(".edit-banking-card").hide();
//});


//// Show Hide Edit KYC Info Card
//$(".edit-kyc-card").hide();
//$("#edit-kyc-info").click(function () {
//    $(".edit-kyc-card").show();
//    $(".view-kyc-card").hide();
//});
//$("#view-kyc-info").click(function () {
//    $(".view-kyc-card").show();
//    $(".edit-kyc-card").hide();
//});
//$("#reset-kyc-info").click(function () {
//    $(".view-kyc-card").show();
//    $(".edit-kyc-card").hide();
//});
